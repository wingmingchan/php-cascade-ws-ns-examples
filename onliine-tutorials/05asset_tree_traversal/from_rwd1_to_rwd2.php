...
try
{
	...
	//$folder        = $cascade->getAsset( a\Folder::TYPE, "de41276e8b7f08560081f1436a5f3eaa" );
	...
	// before running this script, back up the site first!!! AssetOperationHandlerService
